...
while True:
    if os.path.exists('Data/Subscribe.json') == False:
        if os.path.exists('Data') == False:
            os.mkdir('Data')
        os.system('xdg-open https://youtube.com/@khay404')
...
────╔═╝║──────────╔═╝║
────╚══╝──────────╚══╝
\x1b[1;92mGet Facebook Token From Cookies by KH4Y404
\x1b[1;94m--------------------------------------------''') # DO NOT CHANGE THE AUTHOR'S NAME!
        your_cookies = input("\x1b[1;97m[\x1b[1;92m?\x1b[1;97m] MASUKAN COOCKIE :\x1b[1;93m ")
                ...
                if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
                    ...
                    if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
                        ...
                        if 'Sukses!' in str(response6):
                            ...
                            print(f"\x1b[1;97m[\x1b[1;92m*\x1b[1;97m] Kode Token :\x1b[1;92m {access_token}");break
                        else:
